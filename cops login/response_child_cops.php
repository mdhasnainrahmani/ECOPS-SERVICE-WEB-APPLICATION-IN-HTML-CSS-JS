...
?>
	<form action="response_child_database_cops.php" enctype="multipart/form-data" method="post" class="p-5 bg-white">
	...
	<h1>FIR Details</h1>
			  ...
			  <div class="col-md-6">
				  ...
				  <select class= "form-control" name="fir_no" required="" readonly>
				  <option>
				  <?php echo $arr['id'];?>
				  </option>
				...
				<div class="col-md-6">
				  ...
				  <select class= "form-control" name="comp_type" required="" readonly>
				  <option>Child missing</option>
				  </select>
                 <!-- <input type="radio" id="email" class="form-control" placeholder="" name="email">-->
                </div>
				</div>
			  ...
			  <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" value="  <?php echo $arr['date'];?>" readonly id="email" class="form-control" placeholder="" name="date">
                </div>
              </div>
			  <br>
	 <h1> Details of Criminal</h1><br>
			  ...
			  <div class="col-md-6">
				 ...
				 <div class="col-md-6">
                  <label class="font-weight-bold" for="email">Child Status</label>
				  <select class= "form-control" name="status2" required="">
				   <option selected="selected" disabled="disabled">Select Child Status</option>
				  <option>Found</option>
